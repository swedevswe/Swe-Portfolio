  ...
  const projects = [
    {
      ...
      description: "Created a personal portfolio website to showcase software projects and technical skills. Employed advanced CSS for styling and React for dynamic content management.",
      imgUrl: projImg1,
